...
// Auth Pages
const LoginPage = React.lazy(() => import("./pages/auth/LoginPage").then((m) => ({
    default: m.LoginPage,
})));
...
const SystemSchedulePage = React.lazy(() => import("./pages/settings/SystemSchedulePage").then((m) => ({
    default: m.default,
})));
const WaitlistPage = React.lazy(() => import("./pages/waitlist/WaitlistPage").then((m) => ({
    default: m.default,
})));
...
function App() {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200", children: _jsx(Suspense, { fallback: _jsx("div", { className: "p-6", children: _jsx(LoadingSpinner, { size: "large" }) }), children: _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: isAuthenticated ? _jsx(Navigate, { to: "/dashboard", replace: true }) : _jsx(LoginPage, {}) }), _jsx(Route, { element: _jsx(ProtectedRoute, {}), children: _jsxs(Route, { element: _jsx(DashboardLayout, {}), children: [_jsx(Route, { path: "/", element: _jsx(AdminDashboard, {}) }), _jsx(Route, { path: "/admin", element: _jsx(AdminDashboard, {}) }), _jsx(Route, { path: "/dashboard", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/members", element: _jsx(MembersPage, {}) }), _jsx(Route, { path: "/invitations", element: _jsx(InvitationsPage, {}) }), _jsx(Route, { path: "/services", element: _jsx(ServicesPage, {}) }), _jsx(Route, { path: "/media", element: _jsx(MediaPage, {}) }), _jsx(Route, { path: "/settings", element: _jsx(SettingsPage, {}) }), _jsx(Route, { path: "/system-schedule", element: _jsx(SystemSchedulePage, {}) }), _jsx(Route, { path: "/profile", element: _jsx(ProfilePage, {}) }), _jsx(Route, { path: "/analytics", element: _jsx(AnalyticsPage, {}) }), _jsx(Route, { path: "/waitlist", element: _jsx(WaitlistPage, {}) })] }) }), _jsx(Route, { path: "/membership/invitation", element: _jsx(InvitationPageMI, {}) }), _jsx(Route, { path: "/membership/invitation/:invitationId", element: _jsx(InvitationPageMI, {}) }), _jsx(Route, { path: "/membership/registration", element: _jsx(RegistrationPageMI, {}) }), _jsx(Route, { path: "/membership/oath", element: _jsx(OathPageMI, {}) }), _jsx(Route, { path: "/membership/setup", element: _jsx(SetupPageMI, {}) }), _jsx(Route, { path: "/membership/telegram-connect", element: _jsx(TelegramConnectPageMI, {}) }), _jsx(Route, { path: "/membership/submission-confirmation", element: _jsx(SubmissionConfirmationPageMI, {}) }), _jsx(Route, { path: "/membership/mobile-connect", element: _jsx(MobileConnectPageMI, {}) }), _jsx(Route, { path: "*", element: _jsx("div", { children: "404 - Page Not Found" }) })] }) }) }));
}
export default App;
